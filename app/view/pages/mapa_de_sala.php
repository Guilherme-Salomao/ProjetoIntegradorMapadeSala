...
<head>
    ...
    <link rel="stylesheet" href="mapa_de_sala.css">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="bloco verde">Teste/cor</td>
                    <td class="bloco laranja">Teste/cor</td>
                    <td class="bloco lilas">Teste/cor</td>
                    <td class="bloco rosa">Teste/cor</td>
                    <td></td>
                    <td></td>
                    <td></td>
                    <td></td>
